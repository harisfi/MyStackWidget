package com.hryzx.mystackwidget;
...
public class ImageBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.hryzx.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.hryzx.EXTRA_ITEM";
